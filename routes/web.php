...
Route::post('/product_details/{id}/review',
[HomeController::class,'storeReview'])
->name('product_reviews.store');

Route::get('/allproducts',
[HomeController::class,'allproducts'])
...
Route::get('/myorders',
[HomeController::class, 'myOrders'])
->middleware(['auth', 'verified'])
->name('myorders');

Route::get('/addtocart/{id}',
[HomeController::class, 'addToCart'])
->middleware(['auth', 'verified'])
->name('add_to_cart');

Route::get('/cartproducts',
[HomeController::class, 'cartproducts'])
->middleware(['auth', 'verified'])
->name('cartproducts');

Route::get('/removecartproducts/{id}',
[HomeController::class, 'removeCartProducts'])
->middleware(['auth', 'verified'])
->name('removecartproducts');

Route::post('/confirm_order',
[HomeController::class, 'confirm_order'])
->middleware(['auth', 'verified'])
->name('confirm_order');
...
Route::get('/why_us',
[HomeController::class, 'why_us'])
->name('why_us');

Route::get('/increase_quantity/{id}',
[HomeController::class, 'increaseQuantity'])
->name('increase_quantity');

Route::get('/decrease_quantity/{id}',
[HomeController::class, 'decreaseQuantity'])
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('/view_messages',
    [ContactController::class, 'viewMessages'])
    ->name('admin.messages');

    Route::get('/add_category',
    [AdminController::class, 'addCategory'])
    ->name('admin.addcategory');

    Route::post('/add_category',
    [AdminController::class, 'postaddcategory'])
    ->name('admin.postaddcategory');

    Route::get('/view_category',
    [AdminController::class, 'viewCategory'])
    ...
    [AdminController::class, 'postUpdateCategory'])
    ...
    [AdminController::class, 'postaddproduct'])
    ...
    [AdminController::class, 'postupdateproduct'])
    ->name('admin.postupdateproduct');

    Route::any('/admin/search',
    [AdminController::class, 'searchproduct'])
    ->name('admin.searchproduct');

    Route::get('/view_orders',
    [AdminController::class, 'viewOrders'])
    ->name('admin.vieworders');

    Route::post('/change_status/{id}',
    [AdminController::class, 'changeStatus'])
    ->name('admin.change_status');

    Route::get('/downloadinvoice/{id}',
    [AdminController::class, 'downloadInvoice'])
